...
async function main() {
  ...
  // ─── About Skills ───
  await prisma.aboutSkill.createMany({
    data: [
  ...
  // ─── About Tech Tags ───
  await prisma.aboutTechTag.createMany({
    data: ['React', 'TypeScript', 'Figma', 'Tailwind CSS', 'n8n', 'Node.js'].map((name, i) => ({ name, order: i })),
  })
  ...
  // ─── Soft Skills ───
  await prisma.softSkill.createMany({ data: [
  ...
  // ─── Additional Tech ───
  await prisma.additionalTech.createMany({ data: [
  ...
  // ─── Currently Learning ───
  await prisma.currentlyLearning.createMany({ data: [
  ...
  // ─── Degrees ───
  await prisma.degree.createMany({ data: [
  ...
  // ─── Coursework ───
  await prisma.coursework.createMany({ data: [
  ...
  // ─── Contact Cards ───
  await prisma.contactCard.createMany({ data: [
