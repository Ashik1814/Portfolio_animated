        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-3">
            ...
            <nav className="grid grid-cols-2 gap-x-6 gap-y-2">
              {navItems.map((link) => (
                <Link key={link.id} href={link.href} className="text-sm dark:text-[#94a3b8] text-gray-500 dark:hover:text-[#00e5ff] hover:text-[#00a8cc] transition-colors duration-200">{link.label}</Link>
              ))}
            </nav>
          </div>
